...
#ifndef __C51_STDLIB_H
#define __C51_STDLIB_H 1
...
extern char * _ftoa(float);
extern char * _ultosd(unsigned long);
extern char * _ultosh(unsigned long);
extern char * _ultoso(unsigned long);
