...
/* B */
__sbit __at	(0xF7)	B_7		; // B.7;
__sbit __at	(0xF6)	B_6		; // B.6;
__sbit __at	(0xF5)	B_5		; // B.5;
__sbit __at	(0xF4)	B_4		; // B.4;
__sbit __at	(0xF3)	B_3		; // B.3;
__sbit __at	(0xF2)	B_2		; // B.2;
__sbit __at	(0xF1)	B_1		; // B.1;
__sbit __at	(0xF0)	B_0		; // B.0;
...
/* ACC */
__sbit __at	(0xE7)	ACC_7	; // ACC.7;
__sbit __at	(0xE6)	ACC_6	; // ACC.6;
__sbit __at	(0xE5)	ACC_5	; // ACC.5;
__sbit __at	(0xE4)	ACC_4	; // ACC.4;
__sbit __at	(0xE3)	ACC_3	; // ACC.3;
__sbit __at	(0xE2)	ACC_2	; // ACC.2;
__sbit __at	(0xE1)	ACC_1	; // ACC.1;
__sbit __at	(0xE0)	ACC_0	; // ACC.0;
