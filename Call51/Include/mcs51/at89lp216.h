/*  Register Declarations for Atmel's AT89LP216
...
#ifndef REG_AT89LP216_H
#define REG_AT89LP216_H
...
SFR(P1M0, 0xC2);
SFR(P1M1, 0xC3);
SFR(P3,   0xB0); // Port 3 (P3.6 and P3.7 are not available)
	SBIT(P3_5, 0xB0, 5);
	SBIT(P3_4, 0xB0, 4);
	SBIT(P3_3, 0xB0, 3);
	SBIT(P3_2, 0xB0, 2);
