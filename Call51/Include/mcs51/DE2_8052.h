...
__sfr __at (0x96) HEX6;
__sfr __at (0x97) HEX7;
__sfr __at (0xE8) LEDRA; // LEDs LEDR0 to LEDR7
__sfr __at (0x95) LEDRB; // LEDs LEDR8 and LEDR15
__sfr __at (0x9E) LEDRC; // LEDs LEDR16 and LEDR17 and LEDG8
__sfr __at (0xF8) LEDG; // LEDs LEDG0 to LEDG7
__sfr __at (0xE8) SWA; // Switches SW0 to SW7
__sfr __at (0x95) SWB; // Switches SW8 and SW15
__sfr __at (0x9E) SWC; // Switches SW16 and SW17
__sfr __at (0xF8) KEY; // KEY1=KEY.1, KEY2=KEY.2, KEY3=KEY.3.  KEY0 is the reset button!
...
// The bits of LEDG
__sbit __at (0xF8) LEDG_0;
__sbit __at (0xF9) LEDG_1;
__sbit __at (0xFA) LEDG_2;
__sbit __at (0xFB) LEDG_3;
__sbit __at (0xFC) LEDG_4;
__sbit __at (0xFD) LEDG_5;
__sbit __at (0xFE) LEDG_6;
__sbit __at (0xFF) LEDG_7;
