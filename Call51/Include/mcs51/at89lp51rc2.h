/*-------------------------------------------------------------------------
   Register Declarations for the Atmel AT89LP51RC2/RB2 Processor

   Written By -  Jesus Calvino-Fraga / jesusc at ece.ubc.ca (January 2023)
   (Based on AT89LP51RB2/RC2/IC2 Preliminary Datasheet
   from October 2011 by Atmel: https://ww1.microchip.com/downloads/en/DeviceDoc/doc3722.pdf)
...
#ifndef __AT89LP51RC2_H__
#define __AT89LP51RC2_H__
...
sfr at (0xAE) CLKREG;  // Clock Register TPS3 TPS2 TPS1 TPS0 – – – –
    ...
    //#define -    0x02
    //#define -    0x01
sfr at (0x86) OSCCON;  // Oscillator Contro l Register – – – – – SCLKT0 OscBEn OscAEn
    //#define -   0x80
    //#define -   0x40
    //#define -   0x20
    //#define -   0x10
...
sfr at (0x92) BMSEL; // Bank Mode Select Register – – – – – – – FBS
	...
	//#define -  0x02
	#define FBS  0x01
sfr at (0xD1) FCON;  // Flash Control Register FPL3 FPL2 FPL1 FPL0 FPS FMOD1 FMOD0 FBUSY
	#define FPL3   0x80
	#define FPL2   0x40
	#define FPL1   0x20
	#define FPL0   0x10
