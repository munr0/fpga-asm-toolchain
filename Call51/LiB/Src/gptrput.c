...
_gptrput (char *gptr, char c) __naked
{
    ...
    __asm
    ;
    ;   depending on the pointer type according to C51symt.h
    ;
...
#elif defined DC51_MODEL_MEDIUM
...
_gptrputWord ()
{
    __asm
    ;
    ;   depending on the pointer type acc. to C51symt.h
    ;
