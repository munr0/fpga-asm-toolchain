/* Fast printf routine for use with c51/mcs51
...
#warning "printf_fast not built, _C51_NO_ASM_LIB_FUNCS defined"
#endif
...
printf_str_done:
    ...
    /* printing in hex is easy because c51 pushes the LSB first */
