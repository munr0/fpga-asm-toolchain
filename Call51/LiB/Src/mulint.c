...
_mulint (int a, int b)
{
#if !defined(C51_STACK_AUTO) && (defined(C51_MODEL_LARGE) || defined(C51_ds390))	// still needed for large
    union uu __xdata *x;
    union uu __xdata *y;
    union uu t;
